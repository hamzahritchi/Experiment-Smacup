...
<?php } ?>
    ...
    <div class="row">
        ...
        <div class="col-md-offset-3 col-md-6">
            ...
            <div class="form-login"> <h4 class="modal-title">Soal</h4>

        <p>
Petugas pembelian setiap akhir bulan (31 Oktober) melakukan pengecekan Laporan pembelian pada bulan tersebut berdasarkan produk yang dibeli. </p><hr>
...
<ul>
	...
	<li>
		...
		Laporan pembelian disusun berdasarkan kategori.
...
<?php echo $this->M_Pesan->hasil(); ?>
				...
				<tr>
					...
					<td>
						...
						<input name="dari"  required  type="text" class="tgl" autocomplete="off">
				...
				<tr>
					...
					<td>
						...
						<input name="sampai" required type="text" class="tgl" autocomplete="off">
