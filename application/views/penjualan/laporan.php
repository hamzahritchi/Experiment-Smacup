...
<?php } ?>
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            <div class="form-login"><h4 class="modal-title">Soal</h4><p>
Petugas penjualan setiap akhir bulan (30 September) melakukan pengecekan Laporan penjualan pada bulan tersebut berdasarkan produk yang terjual.</p><hr>
...
<?php echo $this->M_Pesan->hasil(); ?>
				...
				<tr>
					...
					<td>
						<input name="dari"  required  class="tgl" type="text" autocomplete="off">
					</td>
				</tr>				
				<tr>
					<td>
					...
					<td>
						<input name="sampai" required class="tgl" type="text" autocomplete="off">
					</td>
				</tr>
				<tr>
					<td>
