...
10 September 2018 Konveksi Baju Baru menerbitkan nota tagihan dengan nomor tagihan SI003 atas resi pengiriman BDO001 untuk pesanan Tuan Andy.</p><hr>
	...
	<tr>
		...
		<tr>
			...
			<td><input required type="text" class="pengirim" name="pengirim" autocomplete="off" pattern="[a-zA-Z0-9]+"><a class="pilih btn btn-default" href='#'>Use</a></td>
...
10 September 2018 Konveksi Baju Baru menerbitkan nota tagihan dengan nomor tagihan SI003 atas resi pengiriman BDO001 untuk pesanan Tuan Andy.</p><hr>
	...
	<tr>
		...
		<tr>
			...
			<td><input type="text" class="pengirim" name="pengirim" autocomplete="off" pattern="[a-zA-Z0-9]+"><a class="pilih btn btn-default" href='#'>Use</a></td>
...
<table class='table' id="ajaxtable">
	...
	<tbody>
		...
		<?php foreach($kwitansi as $p){
			...
			echo $p->kwitansi_term=="fob_shipping_point" ? "<td>FOB Ditanggung Pembeli</td>" : "<td>FOB Ditanggung Penjual</td>";
...
$(document).ready(function() {
    ...
    $('#createKwitansi .pilih').on('click', function() {
        ...
        var id = $("#createKwitansi .pengirim").val();
    ...
    $('#editKwitansi .pilih').on('click', function() {
        ...
        var id = $("#editKwitansi .pengirim").val();
    ...
    $('.editButton').on('click', function() {
        ...
        $.ajax({
            ...
            $('#editKwitansi')
                ...
                .find('form').attr("action","?tipe=update&id="+response.kwitansi_id).end();
