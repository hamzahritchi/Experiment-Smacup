...
Tanggal 5 September 2018, Konveksi Baju Baru menerima pesanan dari Tuan Andy yaitu 50 Lusin Baju Sablon Warna Putih. Harga baju sablon warna putih perlusinnya adalah Rp 500.000 dan biaya pengiriman dilakukan oleh pembeli.</p><hr>
	...
	<tr>
		...
		<tr>
			...
			<td><input class="tgl" type="text" name="tanggal" required" autocomplete="off"></td>
			 ...
			 <tbody>
					 ...
					 <tr> 
					 	...
					 	<td>
					 		...
					 		<select required class='long barang changeble' name="namabarang[]" placeholder="nama Produk" required>
...
Tanggal 5 September 2018, Konveksi Baju Baru menerima pesanan dari Tuan Andy yaitu 50 Lusin Baju Sablon Warna Putih. Harga baju sablon warna putih perlusinnya adalah Rp 500.000 dan biaya pengiriman dilakukan oleh pembeli.</p><hr>
	  ...
	  <form method="post" action="?tipe=update&id=<?php echo $id ?>">
...
?>
	...
	<div class="row">
<h3>Soal</h3>
<p>Tanggal 3 September 2018, pelanggan Konveksi Baju Baru membatalkan pesanannya dengan ID Pesanan S003.</p><br><br>
...
<table class='table' id="ajaxtable">
	...
	<tbody>
		...
		<?php foreach($pesanan as $p){
			...
			echo $p->pesanan_term=="fob_shipping_point" ? "<td>FOB Ditanggung Pembeli</td>" : "<td>FOB Ditanggung Penjual</td>";
			...
			echo " <a href='".base_url()."penjualan/pesanan/?tipe=delete&id=$p->pesanan_id' class='btn btn-default glyphicon glyphicon-trash'></a>";
    ...
    $('.editButton').on('click', function() {
        ...
        $.ajax({
            ...
            $('#editPesanan')
                ...
                .find('form').attr("action","?tipe=update&id="+response.pesanan_id).end();
        ...
        $.ajax({
            ...
            // Populate the form fields with the data returned from server
		      ...
		      //alert(value);
				  ...
				  akun.append($("<td><select value='"+produk+"' class='long changeble barang' autocomplete='off' name='namabarang[]' placeholder='Nama Produk'></select></td>"))
				...
				$('.editdetail .barang').select2({placeholder: "Silahkan Pilih", data:data}).val(produk).trigger("change");
