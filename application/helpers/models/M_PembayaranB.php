	...
	public function tambah_pembayaran()
    {
        ...
        $this->form_validation->set_rules('id', 'ID', 'trim|required|max_length[20]');
		 ...
		 if($this->form_validation->run() == FALSE){
			...
			$case2_a4 = $this->db->where("peserta_id",$peserta)->get("eksperimen_case2")->row()->case2_a1;
			...
			if($this->input->post("tagihan") == "JKT001") $n16 = 1;
			if($this->input->post("jumlah") == "37500000") $n17 = 1;
