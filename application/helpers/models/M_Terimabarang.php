		...
		public function tambah_penerimaan()
		{
		    ...
		    $this->form_validation->set_rules('id', 'id', 'trim|required|max_length[20]');
			 ...
			 if($this->form_validation->run() == FALSE){
				...
				if ($cek == 0) return ["gagal","Pilih tombol 'USE' terlebih dahulu"];
				...
				$this->db->where("peserta_id",$peserta)->where("pesanan_id",$pesanan)->set("pesanan_status",1)->update("eksperimen_pesanan");
