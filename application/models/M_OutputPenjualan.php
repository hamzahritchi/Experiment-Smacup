...
class m_OutputPenjualan extends CI_Model {
	...
	public function jumlah(){
		...
		if($selesai->case1_a1 == 1 && $selesai->case1_a2 == 1 && $selesai->case1_a3 == 1 && $selesai->case1_a4 == 1 && $selesai->case1_a5 == 1)
		$this->session->set_flashdata("hasil",["berhasil","Anda telah menyelesaikan semua soal pada case ini, klik tombol <a href='". base_url("soal/selesai/".md5("case1"))."'>Selesai</a> 
