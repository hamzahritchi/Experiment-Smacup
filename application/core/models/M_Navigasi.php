...
class M_Navigasi extends CI_Model {
...

        {
				...
				$this->nav.="<li><a href=\"#\" data-toggle='modal' data-target='#instruksi' class=\"halonav\">Instruksi</a></li>";
				
				$this->nav.="<li><a href=\"#\" data-toggle='modal' data-target='#soal' class=\"halonav\">Soal</a></li>";
			$this->nav.="<li class=\"dropdown\">";
				...
				$this->nav.="<li><a href=\"".base_url()."soal/konfirmasiselesai\" class=\"halonav\">Selesai</a></li>";
