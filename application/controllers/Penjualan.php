	...
	public function pesanan(){
		...
		if($this->input->get("tipe")){
			...
			switch($tipe){
				...
				break;				
				case "update":
				$hasil=$this->m_Pesanan->update_pesanan($this->input->get("id"));
				break;
				case "delete":
	...
	public function pengiriman(){
		...
		if($this->input->get("tipe")){
			...
			switch($tipe){
				...
				break;
				case "update":
				$hasil=$this->m_Pengiriman->update_pengiriman($this->input->get("id"));
				break;
			}
	...
	public function pengiriman_ajax_harga($kode=0){
		...
		if($this->input->get("tipe")){
			...
			switch($tipe){
				...
				break;				
				case "update":
				$hasil=$this->m_Penagihan->update_penagihan($this->input->get("id"));
				break;
			}
	...
	public function penagihan_detail_ajax($kode=0){
		...
		if($this->input->get("tipe")){
			...
			switch($tipe){
				...
				break;				
				case "update":
				$hasil=$this->m_Pembayaran->update_pembayaran($this->input->get("id"));
				break;
			}
