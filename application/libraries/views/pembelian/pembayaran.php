    ...
    <div class="modal-content fjurnal">
	  ...
	  <div class="modal-body">
		<table class="form">
			...
			<tr><td>Tanggal</td><td><input type="text" class="tgl" required name="tanggal"></td></tr>
    ...
    <div class="modal-content fjurnal">
	  ...
	  <div class="modal-body">
		<table class="form">
			...
			<tr><td>Tanggal</td><td><input type="text" disabled name="tanggal"  class="tgl"></td></tr>
			<tr><td>No tagihan</td><td><input type="text" disabled name="tagihan"></td></tr>
